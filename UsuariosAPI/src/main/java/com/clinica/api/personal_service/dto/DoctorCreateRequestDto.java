...
public class DoctorCreateRequestDto {
    ...
    @Valid
    @NotNull
    private EspecialidadReference especialidad;
    ...
    public EspecialidadReference getEspecialidad() {
        return especialidad;
    }

    public void setEspecialidad(EspecialidadReference especialidad) {
    ...
    public static class EspecialidadReference {
        @NotNull
        private Long id;
